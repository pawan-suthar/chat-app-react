    ...
    <div className=" flex justify-center items-center h-[100vh]  bg-c1">
      <div className="flex items-center flex-col ">
        <div className="text-center">
          <div className="text-4xl font-bold">reate new account</div>
        ...
        <button className="mt-4 w-full h-14 rounded-xl outline-none text-base font-semibold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">Create account</button>
        </form>
        <div className="flex justify-center gap-1 text-c3 mt-5">
          <span>Already have an account?</span>
          <Link to="/login" className="font-semibold text-white underline cursor-pointer">Login now</Link>
        </div>
      </div>
    </div>
  );
